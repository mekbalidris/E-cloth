...
function Shop({cartCount, setCartCount, setCartProducts, setSizeProduct}) {
    ...
    return (
        <>
            <div className={styles.main} style={{filter: isModalOpen ? "blur(11px)" : "blur(0px)" }}>
                ...
                <div className={styles.options}>
                    ...
                    <select placeholder="Select gender" className={styles.gender} onChange={handleGender}>
                ...
                {isModalOpen && (
                    <Modal setCartCount={setCartCount} product={selectedProduct} closeModal={closeModal} setCartProducts={setCartProducts} setSizeProduct={setSizeProduct} className={styles.openModal} />
                )}
